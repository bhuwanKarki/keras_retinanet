 ...
 *     np.ndarray[double, ndim=2] query_boxes
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_15compute_overlap_1compute_overlap, NULL, __pyx_n_s_compute_overlap); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
